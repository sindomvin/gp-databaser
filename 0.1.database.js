    ...
    },
{
    ...
    },
  {
    ...
    },
     {
        ...
        description: 'Meget spændende og grundig bog om pengenes historie, som detaljeret viser hvordan penge også de seneste 5000 år altid har været baseret på gæld. Fuldstændig ligesom penge idag udstedes af bankerne som gæld. I kapitlet "The myth of barter" gennemgår Graeber hvordan og hvorfor mainstream økonomis falske historie om fortidens bytteøkonomi er opstået, og fastholdes idag, som et forsøg på afpolitisering af penge. <br><br>En fuldstændig fremragende bog om pengeteori, meget velskrevet – og for nørder med en til tider underspillet humor. Hvis man ikke vil læse hele den lange bog anbefales især kapitel 1, 2 og 12!<br><br>Kan sikkert både lånes på biblioteket og købes diverse steder i papir, e-bog og lydbog. ', //Beskrivelse af den specifikke Artikel, bog osv.
    ...
    },
    {
        ...
        description: 'Antologi om pengesystemers konsekvenser for international økonomisk ulighed. Hvordan nogle valuta er højere i det globale pengeheriaki end andre. Og hvilken betydning det har om en stat har sit eget pengesystem, dvs. har "monetary sovereignty". Skrevet ud fra et mondern monetary theory (MMT) perspektiv.', //Beskrivelse af den specifikke Artikel, bog osv.
    ...
    },
    {
        ...
        description: 'Andrea er gæst i programmet Udråb på Radio Loud, hvor vi denne gang snakker om penge og hvor de kommer fra, hvordan vi burde omstrukture systemet og meget mere.', //Beskrivelse af den specifikke Artikel, bog osv.
    ...
    },
    {
        ...
        description: 'En rigtig god og tilgængelig bog om pengenes historie, og hvorfor vi har brug for at gøre bedre forståelse af pengessystemet mere mainstream. <br><br>Kan lånes på biblioteket.', //Beskrivelse af den specifikke Artikel, bog osv.
        ...
        description: 'En virkelig god og velskrevet introducerende bog af den tidligere græske finansminister Yanis Varoufakis om problemerne ved det nuværende økonomiske system. <br><br> Tilgængelig på både dansk og engelsk, og kan lånes på biblioteket ', //Beskrivelse af den specifikke Artikel, bog osv.
    ...
    },
     {
        ...
        description: 'En lille og forholdvis let tilgængelig bog om mainstream økonomis blinde vinkler ift. pengenes rolle i økonomien – især ift økonomisk ustabilitet. <br><br> Katarina Juselius var en af verdens mest citerede økonomer i 1990erne, kendt for sit arbejde med makroøkonometriske CVAR-modeller. <br><br>Kan også lånes på biblioteket.', //Beskrivelse af den specifikke Artikel, bog osv.
